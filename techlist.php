...
<html lang="en">
	<head>
		...
		<title>Technical Revamp Registration List</title>
	...
	<body>
			...
			require 'connection.php';
				...
				$query = "select id,name,roll,phone,branch,year,email,tech from registration";
                                ...
                                $num_rows = mysqli_num_rows($result);
                                   echo ' <h1>List of registered students for Cultural Events Solo/Group</h1>
                                    ...
                                    echo '<table class="table table-responsive table-bordered table-striped">
			                             <tr> <th>Sno</th><th>Name</th><th>RollNo</th> <th>Phone No.</th> <th>Branch</th> <th>Year</th><th>Email</th><th>Technical</th> </tr>';
				...
				if($result){
					while($row = mysqli_fetch_assoc($result)){
						...
						$year = $row['year'];                                      
                        $tech = $row['tech'];
                        echo "<tr> <td>$id</td><td>$name</td> <td>$roll</td> <td>$phone</td> <td>$branch</td> <td>$year</td><td>$tech</td>
                                                </tr>";
					}
